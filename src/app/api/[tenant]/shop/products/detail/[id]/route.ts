...
import { getProductsDetailService } from "@/lib/service/server/products/productService"
...
export async function GET(
    ...
    try {
        ...
        const product = await getProductsDetailService(tenantId as string & UUIDString, Number(id))
