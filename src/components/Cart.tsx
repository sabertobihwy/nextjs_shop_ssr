...
export default function Cart() {
    ...
    return (<div className="containerContent flex py-25">
        ...
        <div className="w-56 mx-25 flex flex-col gap-5 items-center">
            <div className="text-2xl font-bold self-start">Total</div>
            <div className="text-2xl font-bold text-red-400 self-start">$100.00</div>
            <Button variant="outline" size="lg" className="text-white bg-black w-2/3 ">Login</Button>
