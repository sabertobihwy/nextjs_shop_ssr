// MockData.ts — About 页面示例数据
export type AboutData = {
    hero: {
        title: string
        subheading: string
        mosaics: {
            main: { src: string; width: number; height: number; alt: string; aos?: string; delay?: number }
            left: { src: string; width: number; height: number; alt: string; topPct: number; maxWidth: number; aos?: string }
            rightTop: { src: string; width: number; height: number; alt: string; topPct: number; maxWidth: number; aos?: string; delay?: number }
            rightBottom: { src: string; width: number; height: number; alt: string; rightPct: number; maxWidth: number; opacity?: number; aos?: string; delay?: number }
        }
    }
    ...
    team: {
        title: string
        members: Array<{ name: string; role: string; src: string; width: number; height: number; alt: string }>
    }
    ...
    benefits: {
        ...
        checklist: string[]
        world: {
            map: { src: string; width: number; height: number; alt: string }
            users: Array<{ src: string; width: number; height: number; alt: string; topPct: number; leftPct: number; delay?: number }>
        }
        testimonial: {
    ...
    footer: {
        ...
        brand: { logoAlt: string; termsHref: string; copy: string }
        socials: Array<{ aria: string; svg: string; href: string }>
    }
}
...
export const AboutMock: AboutData = {
    hero: {
        ...
        mosaics: {
            main: {
                src: '/pro-landing/images/team-mosaic-01.jpg',
                width: 600,
                height: 338,
                alt: 'Team mosaic 01',
                aos: 'fade-down',
            ...
            left: {
                src: '/pro-landing/images/team-mosaic-02.jpg',
                width: 320,
                height: 240,
                alt: 'Team mosaic 02',
                topPct: 45,
            ...
            rightTop: {
                src: '/pro-landing/images/team-mosaic-03.jpg',
                width: 250,
                height: 188,
                alt: 'Team mosaic 03',
                topPct: 8.5,
            ...
            rightBottom: {
                src: '/pro-landing/images/team-mosaic-04.jpg',
                width: 196,
                height: 196,
                alt: 'Team mosaic 04',
                rightPct: 20,
    ...
    timeline: {
        ...
        desc:
            "We were frustrated because content tools hadn't innovated, so we sat down and drew up what we thought a new product could look like.",
        items: [
            {
                badge: '2016',
                label: 'The seed',
                heading: 'Open PRO was founded in Milan, Italy',
                body:
            ...
            },
            {
                badge: '2019',
                label: 'New features',
                heading: 'Launched the first Open PRO Advanced plan',
                body:
                    'Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.',
                delay: 200,
            },
            {
                badge: '2022',
                label: 'Pivoting',
                heading: 'Transitioned to a SaaS business model',
                body:
                    'Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.',
                delay: 400,
            },
            {
                badge: '2026',
                label: 'Huge milestone',
                heading: '1 million happy customers',
                body:
                    'Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.',
                delay: 600,
            },
    ...
    team: {
        ...
        members: [
            { name: 'Lara Lamprecht', role: 'CEO and Founder', src: '/pro-landing/images/team-01.jpg', width: 80, height: 80, alt: 'Team member 01' },
            { name: 'Timothy Chandran', role: 'Head of Sales', src: '/pro-landing/images/team-02.jpg', width: 80, height: 80, alt: 'Team member 02' },
            { name: 'Marie Koniuszek', role: 'Customer Success Lead', src: '/pro-landing/images/team-03.jpg', width: 80, height: 80, alt: 'Team member 03' },
            { name: 'Alyssa Chuzeville', role: 'Head of Product', src: '/pro-landing/images/team-04.jpg', width: 80, height: 80, alt: 'Team member 04' },
            { name: 'Dominik Prasad', role: 'Senior Researcher', src: '/pro-landing/images/team-05.jpg', width: 80, height: 80, alt: 'Team member 05' },
            { name: 'Darya Semenova', role: 'Software Engineer', src: '/pro-landing/images/team-06.jpg', width: 80, height: 80, alt: 'Team member 06' },
            { name: 'Mary Pullgat', role: 'Software Engineer', src: '/pro-landing/images/team-07.jpg', width: 80, height: 80, alt: 'Team member 07' },
            { name: 'Quentin Renvoye', role: 'Senior Marketing Manager', src: '/pro-landing/images/team-08.jpg', width: 80, height: 80, alt: 'Team member 08' },
            { name: 'Justin Jackson', role: 'Content & SEO Lead', src: '/pro-landing/images/team-09.jpg', width: 80, height: 80, alt: 'Team member 09' },
            { name: 'Alice Nguyen', role: 'Engineering Manager', src: '/pro-landing/images/team-10.jpg', width: 80, height: 80, alt: 'Team member 10' },
            { name: 'Duyk Hermann', role: 'Product Designer', src: '/pro-landing/images/team-11.jpg', width: 80, height: 80, alt: 'Team member 11' },
            { name: 'Kevon Cheung', role: 'Creative Director', src: '/pro-landing/images/team-12.jpg', width: 80, height: 80, alt: 'Team member 12' },
        ],
    },

    benefits: {
        title: 'Seeking ambitious problem solvers',
        desc:
            "At Open Pro, it's our mission to improve the quality of every thing. Helping our customers create incredible products and services is the end goal—but everything starts with our team.",
        checklist: [
            'Work Life Balance',
        ...
        world: {
            map: { src: '/pro-landing/images/worldmap.png', width: 672, height: 330, alt: 'World map' },
            users: [
                { src: '/pro-landing/images/world-user-01.jpg', width: 32, height: 32, alt: 'User 01', topPct: 22, leftPct: 52 },
                { src: '/pro-landing/images/world-user-02.jpg', width: 48, height: 48, alt: 'User 02', topPct: 50, leftPct: 58, delay: 400 },
                { src: '/pro-landing/images/world-user-03.jpg', width: 56, height: 56, alt: 'User 03', topPct: 8.5, leftPct: 70.5, delay: 100 },
                { src: '/pro-landing/images/world-user-04.jpg', width: 72, height: 72, alt: 'User 04', topPct: 34, leftPct: 76.5, delay: 700 },
                { src: '/pro-landing/images/world-user-05.jpg', width: 48, height: 48, alt: 'User 05', topPct: 29.5, leftPct: 8.5, delay: 500 },
                { src: '/pro-landing/images/world-user-06.jpg', width: 56, height: 56, alt: 'User 06', topPct: 56, leftPct: 19, delay: 200 },
                { src: '/pro-landing/images/world-user-07.jpg', width: 64, height: 64, alt: 'User 07', topPct: 20, leftPct: 24.5, delay: 600 },
                { src: '/pro-landing/images/world-user-08.jpg', width: 40, height: 40, alt: 'User 08', topPct: 39, leftPct: 43, delay: 300 },
            ],
        },
        testimonial: {
            avatar: { src: '/pro-landing/images/large-testimonial-02.jpg', width: 40, height: 40, alt: 'Large testimonial' },
            quote:
                '“I am grateful to Open PRO for encouraging me to expand my horizons and strive for greater achievements, both in my career and in my education.”',
            name: 'Mary Pullgat',
            link: { label: 'Software Engineer', href: '#0' },
        },
    },
    ...
    clients: {
        title: 'Our customers span the globe',
        logos: [
            {
                svg: `<svg class="max-w-full fill-gray-300" xmlns="http://www.w3.org/2000/svg" width="110"
                                    height="21" viewBox="0 0 110 21">
                                    <path
            ...
            {
                svg: `<svg class="max-w-full fill-gray-300" xmlns="http://www.w3.org/2000/svg" width="86"
                                    height="18" viewBox="0 0 86 18">
                                    <path
            ...
            {
                svg: `<svg class="max-w-full fill-gray-300" xmlns="http://www.w3.org/2000/svg" width="94"
                                    height="39" viewBox="0 0 94 39">
                                    <path
            ...
            {
                svg: `<svg class="max-w-full fill-gray-300" xmlns="http://www.w3.org/2000/svg" width="106"
                                    height="35" viewBox="0 0 106 35">
                                    <path
    ...
    cta: {
        ...
        primary: { label: 'Start Building', href: '#0' },
        secondary: { label: 'Schedule Demo', href: '#0' },
    },
